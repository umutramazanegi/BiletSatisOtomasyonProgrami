...
namespace SinemaBileti
{
    ...
    public partial class FrmAnasayfa : Form
    {
        ...
        {
            string isim = "Umut Ramazan Eği";
            string tarih = DateTime.Now.ToShortDateString(); // Kısa tarih formatı
            string webSitesi = "https://umutramazanegi.com/projelerim/";

            string mesaj = $"Bu program {isim} tarafından {tarih} tarihinde yapılmıştır.\nWeb sitesi: {webSitesi}";

            MessageBox.Show(mesaj, "Program Bilgisi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
